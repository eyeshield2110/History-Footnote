...
class ResetPassword(FlaskForm):
    new_password = PasswordField('Password', validators=[InputRequired(), Length(8, 16)])
    new_password2 = PasswordField('Repeat password', validators=[InputRequired(), EqualTo('new_password', message='Passwords must match.')])
